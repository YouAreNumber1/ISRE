     ...
     <%-- search bar start  --%>
            ...
            <%-- search bar end--%>
			  ...
			  <ul class="nav nav-tabs nav-justified mt-1">
				  ...
				  <li class="nav-item  ">
					  <div class=" ">
						  <a class="nav-link active" data-bs-toggle="tab" href="#home">已報到 <span class="bg-info badge mx-2">9</span></a>
					  </div>
				  </li>
				  <li class="nav-item">
					  <a class="nav-link" data-bs-toggle="tab" href="#menu1">未報到 <span class="bg-warning badge mx-2">19</span></a>
				  </li>
				  <li class="nav-item">
					  <a class="nav-link" data-bs-toggle="tab" href="#menu2">未確認 <span class="bg-danger badge mx-2">29</span></a>
				  </li>
			  </ul>
