...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
							...
							<tbody>
								...
								<tr id="guid<%:mobile %>"
									...
									<td>
										<% if (i < 50)
											{   %>
										<div status="0" class="status badge <%:bgClass %> ">未確認</div>
										<%	}
											else
											{ %>
										<div  status="1" class="badge  <%:bgClass %> ">已確認</div>
										<% } %> 
									</td>
									<td>
										<a class="btn btnEdit btn-primary-isre text-nowrap mx-md-2 mb-1">編輯</a>
					...
					<div class="modal-body   table-responsive">
						<table id="tablePDF" class="table table-borderless "  >
							...
							<tbody>
								...
								<tr>
									<td></td>
									<td><h4>0524「東區第⼆、三類投保單位承保業務說明會」視訊會議</h4>  </td>
									<td></td>
								</tr>
								<tr>
									<td></td>
	...
	<script> 
		...
		var Process_Attend = function (trid) {
			...
			/////// update row status 
			trTarget.find('.status').attr('status', '2');
		...
		$(document).ready(function () {
									...
									if (i <= 2) {  ////// first 3 rows alignment center
										...
										if (i == 2) {
											doc.content[0].table.body[i + 1][1] = {
												/////image: 'data:image/png;base64,'
												//, 
												image: "data:image/png;base64,",
												width: 200,
												alignment: 'center',
												margin: [10, 10]
											};
			...
			$(document).on('keydown', '#scanQRcode', function (e) {
				e.preventDefault(); 
				let btn = $(this);
				console.log('here');
