...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
						...
						<table id="tableList" class="table  table-sm">
							...
							<tbody>
								...
								<tr id="<%:item.GUID %>"
									...
									<td class="left">
										<div>
											<%: (item.CREATEDAT!=null) ? item.CREATEDAT.ToString("yyyy-MM-dd")  : "" %>
										</div>
										<div>
											<%: (item.CREATEDAT!=null) ? item.CREATEDAT.ToString("HH:mm")  : "" %>
										</div>
									</td>
									...
									<td class="left">葷食 </td>
									<td class="left">
										<div class="attendDate"><%: (item.CHECKIN_TIME!=null) ? item.CHECKIN_TIME.ToString("yyyy-MM-dd")  : "" %></div>
										<div class="attendTime"><%: (item.CHECKIN_TIME!=null) ? item.CHECKIN_TIME.ToString("HH:mm")  : "" %></div>
									</td>
	...
	<script> 
		...
		var Process_CheckIn = function (guid) {
			$.ajax({
				url: 'isri0005.aspx/Process_Registers_Status_Update',
			...
			$(document).on('keyup', '#scanQRcode', function (e) {
				...
				if (e.keyCode != 13) {
					...
					if (target == null) {
						...
						if (target.attr('status') != '5') {
							Process_CheckIn(target.attr('id'));
						}
					}
				}
				return;
