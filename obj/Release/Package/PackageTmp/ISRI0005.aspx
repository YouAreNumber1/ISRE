				...
				<div class="card-header">
					<div class="d-flex justify-content-between align-items-center">
						<div>
							...
							<button type="button" id="btnView" class="btn  btn-primary-isre btn-label   me-4 px-sm-4 mb-1">
								<i class="fa-solid fa-eye-slash  "></i>
							</button>

							<button type="button" class="btn  btn-primary-isre  btn-label me-2  mb-1">
