...
<div class="  container">
    <h3 class="text-center my-2"> <%: String.Concat(ActioinName, "活動資訊") %> </h3>
        ...
        <div class="    row  ">
            <div class=" border  py-3   bg-info col-lg-2">
                <span class="note">*</span>
                <b><label>建立⽇期</label></b>
            </div>
      ...
      <%--  @*代理人員*@--%>
        ...
        <div class=" row     ">
            <div class="  bg-info  py-3  border col-lg-2">
    ...
    <option value="">請選擇</option>
      ...
      <%--  @*主辦單位*@--%>
        <div class="  row   ">
            <div class="  border  bg-info   py-3  col-lg-2">
